...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI>* pointProcessorI, const pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
  ...
  float filterRes = 0.5;
  Eigen::Vector4f minPoint(-20, -6, -7, 1);
  Eigen::Vector4f maxPoint(20, 6, 7, 1);
  ...
  std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessorI->euclideanCluster(segmentCloud.first, clusterTolerance, minClusterSize, maxClusterSize);
