...
public:
	...
	void Proximity(typename pcl::PointCloud<PointT>::Ptr cloud,std::vector<int> &cluster,std::vector<bool> &processed_f,int idx,typename KdTree<PointT>::KdTree* tree,float distanceTol, int maxSize);
