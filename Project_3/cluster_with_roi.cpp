...
void runClustering(std::vector<LidarPoint> &lidarPoints, std::vector<BoundingBox> &boundingBoxes)
{
...
{	
	...
	for (auto it1=boundingBoxes.begin(); it1!=boundingBoxes.end(); ++it1)
	{
		...
		putText(topviewImg, str2, cv::Point2f(left-250, bottom+50), cv::FONT_ITALIC, 2, currColor);
	}
...
int main()
{
    ...
    runClustering(lidarPoints, boundingBoxes);
